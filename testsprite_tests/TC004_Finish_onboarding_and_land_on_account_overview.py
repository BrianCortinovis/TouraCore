...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email field with briansnow86@gmail.com, fill the password with Brian8979, submit the form, and wait for the app to redirect to onboarding or account overview.
        frame = context.pages[-1]
        # Input text
        ...
        # -> Retry the login: re-fill email and password, submit the form, and wait for the app to redirect to onboarding or account overview.
        frame = context.pages[-1]
        # Input text
        elem = frame.locator('xpath=/html/body/div[2]/div[2]/div/form/div/input').nth(0)
        await asyncio.sleep(3); await elem.fill('briansnow86@gmail.com')
        ...
        assert '/account/overview' in current_url, "The page should have navigated to the account overview after finishing onboarding."

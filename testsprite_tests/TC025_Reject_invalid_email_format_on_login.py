...
async def run_test():
    ...
    try:
        ...
        # -> Click the 'Accedi' link to open the login page and reveal the login form.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div[2]/section/div[2]/div/div[2]/a[2]').nth(0)
        await asyncio.sleep(3); await elem.click()
        
        # -> Fill the email field with an invalid format, fill the password field, and submit the form to trigger and observe an email validation error.
        frame = context.pages[-1]
        # Input text

import { DistributionClient } from '../../../../(dashboard)/settings/distribution/distribution-client'
import { listDistributionEntitiesAction } from '../../../../(dashboard)/settings/distribution/actions'
...
export default async function DistributionSettingsPage() {
  ...
  return <DistributionClient rows={result.rows} tenantSlug={result.tenantSlug ?? ''} />
}
